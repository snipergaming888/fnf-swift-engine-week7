	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-pixel':
				...
				case 'gf-tankmen':
				frames = Paths.getSparrowAtlas('char/gfTankmen', 'week7');
				...
				case 'tankman':
					playercolor = 'E1E1E1';
					tex = Paths.getSparrowAtlas('char/tankmanCaptain', 'week7');
					frames = tex;
				...
				case 'bf-holding-gf':
					playercolor = '31B0D1';
					frames = Paths.getSparrowAtlas('char/bfAndGF', 'week7');
				...
				case 'bf-holding-gf-DEAD':
					playercolor = '31B0D1';
					frames = Paths.getSparrowAtlas('char/bfHoldingGF-DEAD', 'week7');
			...
			case 'pico-speaker':					
				tex = Paths.getSparrowAtlas('char/picoSpeaker', 'week7');
				frames = tex;
